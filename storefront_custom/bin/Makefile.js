...
target.compileFonts = function () {
    var fontsDir = 'cartridges/app_custom_mybrand/cartridge/static/default/fonts';
    mkdir('-p', fontsDir);
    cp('-r', 'node_modules/font-awesome/fonts/', 'cartridges/app_custom_mybrand/cartridge/static/default');
...
target.release = function (args) {
    ...
    if (['patch', 'minor', 'major'].indexOf(type) >= 0) {
        ...
        var propertiesFileName = path.resolve('./cartridges/app_custom_mybrand/cartridge/templates/resources/version.properties')
